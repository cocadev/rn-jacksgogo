...
import GoClubNewEventDetailTab1 from './goClubNewEventDetailTab1';
...
export default class GoClubNewEventDetail extends React.Component {
  ...
  render() {
    return (
      <View style={commonStyles.container}>
        <Header title="Create New Event"leftElement={(
